...
class _CertificatedWidgetState extends State<CertificatedWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 15),
        widget.boosterData.isNotEmpty
            ? CertificatCard(
                title: "Booster Dose: ",
                date: uData.booster_date,
                manufacturer: widget.boosterData["manufacturer"] ?? "",
                batch: widget.boosterData["batch"] ?? "",
                facility: widget.boosterData["facility"] ?? "",
                isBorder: true,
              )
            : Container(),
        Row(
            ...
            return pw.Container(
              ...
              child: pw.Column(children: [
                ...
                pdfVaccineWidget(
                    3,
                    uData,
                    widget.boosterData["facility"],
                    widget.userData["booster"],
                    widget.boosterData["manufacturer"],
                    widget.boosterData["batch"]),
              ]),
            );
          },
        ),
  ...
  pw.Widget pdfBoosterWidget(int doseNum, UserData uData, String facility,
      String vaccineName, String manufacturer, String batchNo) {
    String uid = FirebaseAuth.instance.currentUser!.uid;
    return pw.Container(
        margin: pw.EdgeInsets.only(top: 15),
                ...
                child: pw.Column(
                    ...
                    children: [
                      pw.Text("Tarikh Divaksin / Date of Vaccination",
                          style: pw.TextStyle(
                              fontStyle: pw.FontStyle.italic, fontSize: 10)),
                      pw.Text(uData.booster_date.split(" ")[0],
                          style: pw.TextStyle(
                              fontSize: 10, fontWeight: pw.FontWeight.bold)),
                      pw.SizedBox(height: 5),
                      pw.Text("Pusat Pemberian Vaksin / Vaccination Center",
